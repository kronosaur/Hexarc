...
//	Returns the next message
	...
	{
	ASSERT(!m_sCachedCommand.IsEmpty());
...
//	Reads a message from the buffer
	...
	CString sHeader(pStart, (int)(pPos - pStart));
	...
	CString sCommand(pStart, (int)(pPos - pStart));
	if (sCommand.IsEmpty())
		{
		*retsCommand = AI1_INVALID_MESSAGE;
		*retdPayload = CDatum();
...
//	Writes a message to a data object suitable for Esper.write
	...
	CDatum::CreateString(Output, retdData);
	}
