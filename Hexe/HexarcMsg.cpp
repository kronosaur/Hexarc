...
DECLARE_CONST_STRING(ADDR_GRIDFS_COMMAND,				"GridFS.command")
...
DECLARE_CONST_STRING(MSG_GRIDFS_LIB_FILE_CAN_ACCESS,	"GridFS.libFileCanAccess");
DECLARE_CONST_STRING(MSG_GRIDFS_LIB_FILE_DIRECTORY,		"GridFS.libFileDirectory");
DECLARE_CONST_STRING(MSG_GRIDFS_LIB_FILE_READ,			"GridFS.libFileRead");
DECLARE_CONST_STRING(MSG_GRIDFS_LIB_FILE_WRITE,			"GridFS.libFileWrite");
...
CHexeProcess::SHexarcMsgInfo CHexeProcess::m_HexarcMsgInfo[] =
	{
		...
		{	MSG_GRIDFS_LIB_FILE_CAN_ACCESS,	ADDR_GRIDFS_COMMAND,		0	},
		{	MSG_GRIDFS_LIB_FILE_DIRECTORY,	ADDR_GRIDFS_COMMAND,		0	},
		{	MSG_GRIDFS_LIB_FILE_READ,		ADDR_GRIDFS_COMMAND,		0	},
		{	MSG_GRIDFS_LIB_FILE_WRITE,		ADDR_GRIDFS_COMMAND,		0	},
