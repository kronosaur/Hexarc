...
SLibraryFuncDef g_CoreLibraryDef[] =
	{
	DECLARE_DEF_LIBRARY_FUNC(DATETIME, coreDateTime),
	DECLARE_DEF_LIBRARY_FUNC(DATETIME_FORMAT, coreDateTime),
	DECLARE_DEF_LIBRARY_FUNC(DATETIME_SPAN, coreDateTime),

	DECLARE_DEF_LIBRARY_FUNC(LIST_APPEND, coreLists),
	DECLARE_DEF_LIBRARY_FUNC(LIST_COUNT, coreLists),
	DECLARE_DEF_LIBRARY_FUNC(LIST_GROUP, coreLists),
	DECLARE_DEF_LIBRARY_FUNC(LIST_ITEM, coreLists),
	DECLARE_DEF_LIBRARY_FUNC(LIST_ITEM2, coreLists),
	DECLARE_DEF_LIBRARY_FUNC(LIST_LIST, coreLists),
	DECLARE_DEF_LIBRARY_FUNC(LIST_MAKE, coreLists),
	DECLARE_DEF_LIBRARY_FUNC(LIST_SORT, coreLists),
	DECLARE_DEF_LIBRARY_FUNC(LIST_STRUCT, coreLists),

	DECLARE_DEF_LIBRARY_FUNC(MATH_ABS, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_ACOS, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_ASIN, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_ATAN, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_ATAN2, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_CEIL, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_COS, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_DIGEST, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_EXP, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_FLOOR, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_INTIP_TO_INT32, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_LOG, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_MAX, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_MIN, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_MOD, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_POW, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_RANDOM, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_ROUND, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_SIN, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_SQRT, coreMath),
	DECLARE_DEF_LIBRARY_FUNC(MATH_TAN, coreMath),
	...
	DECLARE_DEF_LIBRARY_FUNC(STR_FROM_ARS, coreStrings),
	DECLARE_DEF_LIBRARY_FUNC(STR_HEX, coreStrings),
	DECLARE_DEF_LIBRARY_FUNC(STR_HTML, coreStrings),
	DECLARE_DEF_LIBRARY_FUNC(STR_JOIN, coreStrings),
	DECLARE_DEF_LIBRARY_FUNC(STR_LENGTH, coreStrings),
	DECLARE_DEF_LIBRARY_FUNC(STR_LOWERCASE, coreStrings),
	DECLARE_DEF_LIBRARY_FUNC(STR_SPLIT, coreStrings),
	DECLARE_DEF_LIBRARY_FUNC(STR_SUBSTRING, coreStrings),
	DECLARE_DEF_LIBRARY_FUNC(STR_TO_JSON, coreStrings),
	DECLARE_DEF_LIBRARY_FUNC(STR_TYPE_OF, coreStrings),
	DECLARE_DEF_LIBRARY_FUNC(STR_URL_PARAM, coreStrings),

	DECLARE_DEF_LIBRARY_FUNC(SYS_TICKS, coreSystem),
	};
